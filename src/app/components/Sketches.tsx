    ...
    <div className="absolute inset-0 overflow-y-auto overflow-x-hidden bg-white">
      ...
      <div className="w-full relative min-h-full" ref={containerRef}>
        ...
        */}
        ...
        >
          <h1 className="font-display text-[22px] md:text-[28px] leading-[1.2] font-normal mb-3 text-[#B8552E]">
            Welcome to my design sketches.
          </h1>
          <p className="font-['Inter'] text-[15px] md:text-[16px] text-neutral-700 leading-relaxed mb-3 font-light">
          ...
          <p className="font-['Inter'] text-[13px] md:text-[14px] leading-relaxed font-medium" style={{ color: '#7A2A1F' }}>
