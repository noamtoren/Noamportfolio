            ...
            {tabs.map((tab) => {
              ...
              if (tab.id === 'contact') {
                return (
                  <a
                    ...
                    className="relative flex items-center justify-center py-2 px-4 rounded-md bg-neutral-700/40 border border-neutral-500/60 text-neutral-300 transition-colors duration-300 hover:bg-white hover:text-neutral-900 hover:border-white"
                  >
              ...
              return (
                <button
                  ...
                  className={`relative flex items-center justify-center py-2 px-4 rounded-md transition-colors duration-300 ${
                    isActive
                      ? 'text-white'
